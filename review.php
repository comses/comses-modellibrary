...
function openabmma_reviewModels() {
  ...
  while ($version = db_fetch_object($result)) {
    ...
    $modelName = openabmma_getModelName($version->model_id);
    $pTitle = openabmma_getModelTitle($version->model_id);
    $pOwner = openabmma_getModelOwner($modelName);
    $versionNumber = $version->version_num;
    $output .= "\n<tr class='openabmData'><td class='openabmCol'>" . $count . "</td><td class='openabmCol'>" . l($pTitle . " [" . $modelName . "] v" . $versionNumber, "review/" . $modelName . "/version" . $versionNumber) . "</td><td class='openabmCol'>" . $pOwner . "</td><td class='openabmCol'>" . $desc . "</td><td>" . $version->date_modified . "</td></tr>";
  }
...
function openabmma_reviewThisModel() {
  ...
  $output .= "<tr class='openabmData'><td width='30%'><b>Model name:</b></td><td><b>" . $modelName . "</b></td></tr>";
